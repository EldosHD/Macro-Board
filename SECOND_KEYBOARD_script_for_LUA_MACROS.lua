...
local keyboardIdentifier = '1199647D'
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\Valen\\Github\\Macro-Board\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
